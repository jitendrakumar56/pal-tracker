...
public class EnvController {
   ...
   public EnvController(@Value("${port: Dport}") String port,
                  @Value("${memory.limit: DMerory}") String memory_limit,
                  @Value("${cf.instance.index: DIndex}") String cf_instance_index,
                  @Value("${cf.instance.addr: DAddr}") String cf_instance_addr){
        this.port = port;
